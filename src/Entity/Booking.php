...
class Booking
{
     ...
     * @Assert\Date(message="Attention, la date d'arrivée doit être au format date")
    ...
    /**
     * @ORM\Column(type="datetime")
     * @Assert\Date(message="Attention, la date de départ doit être au format date")
    ...
    /**
     * Callback appelé à chaque création de réservation
     *
     * @ORM\PrePersist()
     * @ORM\PreUpdate()
     */
    ...
    /**
     * Permet de récupérer le tableau des jours correspondants à la réservation
     *
     * @return array
     */
